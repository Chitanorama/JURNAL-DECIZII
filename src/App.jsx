  ...
  if(!ap)return(
    <div style={{fontFamily:"var(--font-sans)",background:"#f8f7f5",minHeight:"100vh"}}>
      <div style={{background:"#fff",borderBottom:"1.5px solid #e0ddd8",padding:"0 20px",display:"flex",alignItems:"center",justifyContent:"space-between",height:52}}>
        ...
        <div style={{marginTop:16,padding:"12px",background:"#f0eeeb",borderRadius:8,fontSize:13}}>
          <button onClick={testConnection} style={{fontSize:13,padding:"6px 14px",marginBottom:8,display:"block"}}>Testeaza conexiunea Supabase</button>
          {testMsg&&<div style={{color:testMsg.includes("EROARE")?"#A32D2D":"#3B6D11",fontWeight:500}}>{testMsg}</div>}
        </div>
